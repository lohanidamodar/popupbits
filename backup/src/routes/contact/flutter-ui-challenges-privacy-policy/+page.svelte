		...
		<div class="container">
			<div class="tab-content translations-content-item en visible" id="en">
				...
				<ul>
					...
					<li>
						<p>
							<strong>Application</strong> refers to Flutter UI Challenges, the software program provided
							by the Company.
						</p>
					</li>
					<li>
						<p>
							...
							Agreement) refers to Flutter UI Challenges.
						</p>
					</li>
					<li>
				...
				<ul>
					<li>
						<p>By email: popupbits@gmail.com</p>
					</li>
					<li>
						<p>
							By visiting this page on our website: <a
								href="https://github.com/lohanidamodar/flutter_ui_challenges/issues"
								rel="external nofollow noopener"
								target="_blank">https://github.com/lohanidamodar/flutter_ui_challenges/issues</a
							>
						</p>
					</li>
				</ul>

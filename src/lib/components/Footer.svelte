			...
			<div class="footer-main">
				<div class="footer-brand">
					<div class="brand-logo">
						<h3 class="footer-logo">{companyData.name}</h3>
						<div class="logo-accent"></div>
					</div>
					<p class="footer-tagline">{companyData.tagline}</p>
					...
					<div class="footer-social">
						...
						<a href={companyData.social.email} aria-label="Email" class="social-link">
							<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
								<path
					...
					<div class="footer-section">
						...
						<ul>
							<li class="contact-item">
								...
								<span>
									{companyData.contact.address.street}, {companyData.contact.address.city}
									{companyData.contact.address.zone}, {companyData.contact.address.country}
								</span>
							</li>
							<li class="contact-item">
								<svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
